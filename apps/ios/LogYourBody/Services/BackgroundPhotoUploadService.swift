    ...
    private func createBodyMetrics(for date: Date) async -> BodyMetrics {
        ...
        if let existing = existingMetrics {
            ...
            return BodyMetrics(
                ...
                waistCm: existing.waistCircumference > 0 ? existing.waistCircumference : nil,
                hipCm: existing.hipCircumference > 0 ? existing.hipCircumference : nil,
                waistUnit: existing.waistUnit,
