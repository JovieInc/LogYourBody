        ...
        OnboardingPageTemplate(
            ...
            VStack(spacing: 28) {
                VStack(alignment: .leading, spacing: 16) {
                    ...
                    .overlay(
                        RoundedRectangle(cornerRadius: 20, style: .continuous)
                            .stroke(emailFieldFocused ? Color.appPrimary : Color.appBorder.opacity(0.4))
                    )

                    OnboardingCaptionText(text: "We’ll send your Body Score and keep progress synced.", alignment: .leading)
                }
            ...
            .opacity(viewModel.canContinueEmailCapture ? 1 : 0.4)
        }
        .onAppear {
