...
REVENUE_CAT_API_KEY="${REVENUE_CAT_API_KEY:-${IOS_REVENUE_CAT_API_KEY:-}}"
...
require_value "REVENUE_CAT_API_KEY" "$REVENUE_CAT_API_KEY"
...
REVENUE_CAT_API_KEY = $REVENUE_CAT_API_KEY
STATSIG_CLIENT_SDK_KEY = $STATSIG_CLIENT_SDK_KEY
