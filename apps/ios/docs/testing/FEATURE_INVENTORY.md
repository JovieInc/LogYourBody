...
| `PreferencesView` profile editor sheets                                       | `Views/PreferencesView+AccountSection.swift` | M    | unit            | 🔶 `ProfileSettingsPolicyTests` (name/height/age policy); live editors in PreferencesView                       |
