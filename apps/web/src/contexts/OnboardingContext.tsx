...
import { useAuth } from './ProductAuthContext';
        ...
        const metricsToInsert = data.confirmedScans.map((scan) => ({
          ...
          weight:
            typeof scan.weight === 'number'
              ? scan.weight_unit === 'lbs'
                ? scan.weight * 0.453592
                : scan.weight
              : undefined, // Convert to kg when weight is present
          weight_unit: 'kg',
          body_fat_percentage: scan.body_fat_percentage || null,
          body_fat_method: 'dexa',
          bone_mass: scan.bone_mass
            ? scan.weight_unit === 'lbs'
              ? scan.bone_mass * 0.453592
              : scan.bone_mass
            : null, // Convert to kg if needed
