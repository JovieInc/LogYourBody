...
| --- | --------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------ |
| 1   | **Launch**      | The app boots to the pinned paid surface (photo timeline HUD) with the chat composer on the home hero; Timeline/Stats use Jovie swipe and the menu, not top tabs; Apple is the only primary sign-in method; the RevenueCat entitlement is `Premium`.         | `GoldenPathTests` GP1; launch-quality navigation XCUITests                                |
