...
| `AUD-007` | Web readiness coverage improved                             | `pnpm --filter logyourbody test:coverage` passes with 36 suites / 308 tests and 7.68% line coverage                                                                                    |
...
| ----------------------- | ----------------------------------------------------------------------------------------------------------------------------------------- |
| Merged PR               | `#440` merged to `main` at `eeb2ebf860047faffba0bf82d1323c475d0c545e`                                                                     |
| Post-merge CI           | GitHub run `28002701753` completed successfully                                                                                           |
| Web deploy              | GitHub run `28002701756` completed successfully                                                                                           |
| iOS release loop        | GitHub run `28002701832` completed successfully                                                                                           |
| TestFlight upload       | `Deploy to TestFlight / Deploy to TestFlight (production)` completed successfully in run `28002701832`                                    |
| GitHub release artifact | `ios-v1.2.0-testflight.20260623045503` created at `2026-06-23T05:07:12Z`                                                                  |
