...
- Local config: ignored `Config.xcconfig` with non-secret development placeholders. This allowed UI/build inspection only; it did not prove production Clerk, RevenueCat, or first-party product API behavior.
